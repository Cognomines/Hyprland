...
#define MS makeConfigValue
    ...
    return std::vector<SP<IValue>>{
        ...
        MS<Gradient>("general:col.active_border_foreign", "border color for windows focused by non-default seats", CHyprColor{0xffffa500ff},
                     {.refresh = Supplementary::REFRESH_WINDOW_STATES}),
        MS<String>("general:col.seat_active_borders",
                   "space-separated border colors for non-default seats, i-th entry = i-th non-default seat; missing entries fall back to col.active_border_foreign",
                   "rgba(ffa500ff)", {.refresh = Supplementary::REFRESH_WINDOW_STATES}),
        ...
        MS<Float>("decoration:foreign_opacity", "opacity of windows focused by non-default seats.", 1, {.min = 0, .max = 1, .refresh = Supplementary::REFRESH_WINDOW_STATES}),
        MS<Float>("decoration:foreign_dim_strength", "dim strength of windows focused by non-default seats. Requires decoration:dim_inactive.", 0,
